...
from mixins import DistributedDataloader, SubsampleDataset
...
class Trainer(BaseTrainer):
    ...
    def sampling_step(self, epoch):
        ...
        gathered_entropy = gather(training_data["entropies"]).mean()
    ...
    def validation_step(self, epoch):
        ...
        gathered_entropy = gather(val_data["entropies"]).mean()
