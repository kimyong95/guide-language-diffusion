...
def get_config():
    ...
    config.sample.total_samples = 320     # B: total rollouts per epoch across all GPUs
    config.sample.m = 64                  # unique questions per epoch; group size (generation batch) k = B/m = 8
