...
def base():
    ...
    config.total_iterations = 100  # total programs generated/evaluated (one per iteration)
    ...
    config.num_inspirations = 3     # programs shown to the model besides the parent
